var WebFontConfig,main;main=function(){var e,t,o,n,r,a,l,s,d,i,c,h,u,f,p,g,y,v,w,m,b,T,k,x,P,S,C,A,E,B,I,D,M,O,H,_,F,N,L,j,G,R,W,q,U,Y,z,K,V,J,Z,Q,X,ee,te,oe,ne,re,ae,le,se,de,ie,ce,he,ue,fe,pe,ge,ye,ve,we,me,be,Te,ke,xe,Pe,Se,Ce,Ae,Ee,Be,Ie;h="flappy",e=!1,c=160,o=1100,t=320,i=1/1200,s=100,d=1,l=6,a=384,u=500,n=64,r=a-n,ne=document.querySelector("#screen"),N=void 0,D=void 0,S=[],P=[],x=[],J=[{name:"Arpit",score:"58",hall:"AZ"},{name:"Apoorv",score:"2",hall:"NH"},{name:"Vikrant",score:"1",hall:"RP"},{name:"Arkanath",score:"100",hall:"MS"}],W=["AZ","MT","RP","SN","NH","PT","RK","LLR","MS","LBS","MMM","HJB"],b=null,V=!1,R=!1,y=null,Ee=null,K=null,v=null,j=null,G=null,M=null,te=null,Z=null,ee=null,ge=null,re=null,ue=null,pe=null,z=null,F=null,Ae=null,H=null,_=null,ae=null,E=null,fe=null,Y=null,C=null,Ce=null,U=null,T=null,Be=null,me=null,oe=12,w=null,Q=null,L='<iframe src="http://ghbtns.com/github-btn.html?user=hyspace&repo=flappy&type=watch&count=true&size=large"\nallowtransparency="true" frameborder="0" scrolling="0" width="150" height="30"></iframe>',B=Math.floor,de=function(e,t){var o,n,r;for(n="",o=r=e;1>=e?1>=r:r>=1;o=1>=e?++r:--r)n+=t[Math.floor(Math.random()*t.length)];return n},be=function(e,t){var o,n,r;return o=null,n=t?"tubeTop":"tubeBottom",r=B(t?e-s/2-320:e+s/2),S.length>0&&"tubeTop"===n?(o=S.pop().revive(),o.reset(I.world.width,r)):P.length>0&&"tubeBottom"===n?(o=P.pop().revive(),o.reset(I.world.width,r)):(o=Ee.create(I.world.width,r,n),I.physics.arcade.enableBody(o),o.body.allowGravity=!1),o.body.velocity.x=-c,o},Te=function(){var e,t,o,n;Ee.forEachAlive(function(e){e.x+e.width<I.world.bounds.left&&("tubeTop"===e.key&&S.push(e.kill()),"tubeBottom"===e.key&&P.push(e.kill()))}),K.forEachAlive(function(e){e.x+e.width<I.world.bounds.left&&x.push(e.kill())}),n=I.world.height/2+(Math.random()-.5)*I.world.height*.2,e=be(n),o=be(n,!0),x.length>0?t=x.pop().revive().reset(o.x+o.width/2,0):(t=K.create(o.x+o.width/2,0),I.physics.arcade.enableBody(t),t.width=2,t.height=I.world.height,t.body.allowGravity=!1),t.body.velocity.x=-c},g=function(e,t){K.remove(t),ue+=1,pe.setText(ue),fe.play()},he=function(){for(J.sort(function(e,t){return parseInt(e.score)<parseInt(t.score)});J.length<l;)J.push({name:"---",score:"-1",hall:"DUMMY2"});return J},ye=function(){var e;return e={score:ue,name:re,hall:W[b],key:ge,token:q(ue+ge+h+ue)},$.ajax({type:"POST",data:e,dataType:"text",url:"/sendScore",success:function(e){return console.log(e)},error:function(){return console.log("error sending score!")}})},we=function(){var e,t;return e=ye(),Q.input.enabled=!1,M.alive?(t=I.add.tween(M).to({y:1.5*I.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),me.onDown.removeAll(),y.events.onInputDown.removeAll(),t.onComplete.add(function(){var o,n,r,a,l,s,d;for(M.kill(),Z.revive(),Z.bringToTop(),t=I.add.tween(Z).to({y:I.world.height/2},800,Phaser.Easing.Back.Out,!0),r="",n="",a="",Z.children[1].setText("Loading.."),Z.children[2].setText(""),Z.children[0].setText(""),l=s=3,d=Z.children.length-1;d>=3?d>=s:s>=d;l=d>=3?++s:--s)Z.children[l].kill();return o=function(){var e,t,o,l;for(t=o=0,l=J.length-1;l>=0?l>=o:o>=l;t=l>=0?++o:--o)J[t].score<0?(r+="\n-",n+="\n---",a+="\n---",Z.children[3+t].kill()):(r+="\n"+(t+1),n+="\n"+J[t].name,a+="\n"+J[t].score,e=Z.children[3+t],e.revive(),e.frameName=J[t].hall+"/2",e.children[0].setText(J[t].hall));return Z.children[0].setText(r),Z.children[1].setText(n),Z.children[2].setText(a)},$.when(e).done(function(e){return $.ajax({type:"GET",url:"/getLeaderboard",success:function(e){return J=e,console.log("got lb = "+J),he(),o()},error:function(){return J=[],he(),o()}})}),t.onComplete.add(function(){var e;return e=function(){return Z.alive?(t=I.add.tween(Z).to({y:1.5*I.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),me.onDown.removeAll(),y.events.onInputDown.removeAll(),t.onComplete.add(function(){return Z.kill(),ce()})):ce()},y.events.onInputDown.addOnce(e),me.onDown.addOnce(e)})})):void 0},p=function(e,t,o){var n;return n=I.add.sprite(e,t,"sheet",W[o]+"/2"),n.scale.setTo(2,2),n.smoothed=!1,n.anchor.setTo(.5,.5),n},xe=function(){return y.inputEnabled=!1,me.onDown.removeAll(),ae.startFocus(),ae.focus=!0,ae.placeHolder.visible=!1},Se=function(){return ae.endFocus(),ae.focus=!1,y.inputEnabled=!0},O=function(){var e;return me.onDown.removeAll(),y.events.onInputDown.removeAll(),M.revive(),Q.input.enabled=!1,M.bringToTop(),e=I.add.tween(M).to({y:I.world.height/2},800,Phaser.Easing.Back.Out,!0),e.onComplete.add(function(){var t;return Q.input.enabled=!0,t=function(){return ye(),Q.input.enabled=!1,M.alive?(e=I.add.tween(M).to({y:1.5*I.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),me.onDown.removeAll(),y.events.onInputDown.removeAll(),e.onComplete.add(function(){return M.kill(),ce()})):ce()},y.events.onInputDown.addOnce(t),me.onDown.addOnce(t)}),Ce.play()},ve=function(){var e;D=!0,v.body.velocity.y>0&&(v.body.velocity.y=100),v.animations.stop(),v.frame=W[b]+"/2",e=window.localStorage.getItem("hiscore"),e=e?e:ue,e=ue>parseInt(e,10)?ue:e,window.localStorage.setItem("hiscore",e),H.setText(ue),_.setText(e),Ee.forEachAlive(function(e){e.body.velocity.x=0}),K.forEach(function(e){e.body.velocity.x=0}),I.time.events.remove(Be),I.time.events.add(1e3,function(){return V?O():X(O)}),Y.play()},A=function(){var e;N||ke(),D||(v.body.gravity.y=0,v.body.velocity.y=-100,e=I.add.tween(v.body.velocity).to({y:-t},25,Phaser.Easing.Bounce.In,!0),e.onComplete.add(function(){return v.body.gravity.y=o}),E.play())},se=function(){var e;I.load.atlasJSONHash("sheet","assets/sheet.png","assets/sheet.json"),e={spritesheet:{leaderboard:["assets/leaderboard.png",52,29]},image:{tubeTop:["assets/tube1.png"],tubeBottom:["assets/tube2.png"],ground:["assets/path.png"],bg:["assets/bg2.png"],hall:["assets/hall.png"],gameover:["assets/gameover-panel.png"],lbPanel:["assets/lbPanel.png"],nameScreen:["assets/name.png"]},audio:{flap:["assets/sfx_wing.mp3"],score:["assets/sfx_point.mp3"],hurt:["assets/sfx_hit.mp3"],fall:["assets/sfx_die.mp3"],swoosh:["assets/sfx_swooshing.mp3"],click:["assets/keyboard_tap.mp3"],hover:["assets/typewriter_key.mp3"]}},Object.keys(e).forEach(function(t){Object.keys(e[t]).forEach(function(o){I.load[t].apply(I.load,[o].concat(e[t][o]))})})},q=function(e){var t,o,n,r,a,l;if(o=0,0===e.length)return o;for(r=e.length,n=a=0,l=r-1;l>=0?l>=a:a>=l;n=l>=0?++a:--a)t=e.charCodeAt(n),o=(o<<5)-o+t,o|=0;return o},k=function(){var e,t,o,s,i,c,h,f,g,b,k,x,P,S,A,B;for(I.add.plugin(Fabrique.Plugins.InputField),I.physics.startSystem(Phaser.Physics.ARCADE),console.log("%chttps://github.com/hyspace/flappy","color: black; font-size: x-large"),c=window.innerWidth/window.innerHeight,(c>1.15||.7>c)&&(document.querySelector("#github").innerHTML=L),document.querySelector("#loading").style.display="none",I.scale.pageAlignVertically=!0,I.smoothed=!1,I.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,I.scale.windowConstraints.bottom="visual",I.scale.setGameSize(u,a),y=I.add.tileSprite(0,0,u,a,"bg"),y.smoothed=!0,y.inputEnabled=!0,y.input.priorityID=0,v=I.add.sprite(0,0),Ee=I.add.group(),K=I.add.group(),ee=I.add.group(void 0,void 0,!1,!0,Phaser.Physics.ARCADE),j=I.add.tileSprite(0,r,u,n,"ground"),j.tileScale.setTo(d,d),pe=I.add.text(I.world.width/2,I.world.height/4,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),pe.anchor.setTo(.5,.5),z=I.add.text(I.world.width/2,I.world.height-I.world.height/4,"",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),z.anchor.setTo(.5,.5),F=I.add.text(I.world.width/2,I.world.height/2,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),F.anchor.setTo(.5,.5),F.scale.setTo(d,d),Z=I.add.sprite(I.world.width/2,1.5*I.world.height,"lbPanel"),Z.anchor.setTo(.5,.5),Z.kill(),b=I.add.text(-170,-10,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),b.anchor.setTo(.5,.5),g=I.add.text(20,-10,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),g.anchor.setTo(.5,.5),k=I.add.text(150,-10,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"right"}),k.anchor.setTo(.5,.5),A=[b,g,k],x=0,S=A.length;S>x;x++)f=A[x],f.lineSpacing=15;for(Z.addChild(b),Z.addChild(g),Z.addChild(k),o=P=0,B=l-1;B>=0?B>=P:P>=B;o=B>=0?++P:--P)h=p(-120,-105+41*o,0),e=I.add.text(0,10,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),e.scale.setTo(.5,.5),e.smoothed=!1,e.anchor.setTo(.5,.5),h.addChild(e),h.kill(),Z.addChild(h);te=I.add.sprite(0,0,"nameScreen",void 0,ee),te.anchor.setTo(.5,.5),te.kill(),ee.x=I.world.width/2,ee.y=1.5*I.world.height,M=I.add.sprite(I.world.width/2,1.5*I.world.height,"gameover"),M.anchor.setTo(.5,.5),M.kill(),Ae=I.add.text(0,M.height/2-20,"Touch to Try Again",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),Ae.anchor.setTo(.5,.5),M.addChild(Ae),t=t=I.add.text(M.width/4-10,-30,"Score\n\nBest",{font:'24px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),t.anchor.setTo(0,0),M.addChild(t),H=I.add.text(M.width/4-10,0,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),H.anchor.setTo(0,0),M.addChild(H),_=I.add.text(M.width/4-10,68,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),_.anchor.setTo(0,0),M.addChild(_),Q=I.add.button(-100,0,"leaderboard",we,this,0,0,1),Q.events.onInputUp.add(function(){return T.play()}),Q.scale.setTo(2,2),Q.anchor.setTo(.5,.5),Q.smoothed=!1,M.addChild(Q),i=I.add.text(0,-30,"Enter Name",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),i.anchor.setTo(.5,.5),te.addChild(i),s=I.add.text(0,60,"Press Enter to continue",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),s.anchor.setTo(.5,.5),te.addChild(s),ae=I.add.inputField(-75,10,{font:'16px "Press Start 2P"',fill:"#430",cursorColor:"#430",backgroundColor:"#ffffff",placeHolder:"name",placeHolderColor:"#874",height:30,width:150,type:Fabrique.InputType.text},ee),ae.anchor.setTo(0,.3),ae.bringToTop(),E=I.add.audio("flap"),E.allowMultiple=!0,fe=I.add.audio("score"),Y=I.add.audio("hurt"),C=I.add.audio("fall"),Ce=I.add.audio("swoosh"),U=I.add.audio("hover"),T=I.add.audio("click"),v.kill(),w=[],m()},m=function(){var e,t,o,n,r,a,l,s,d,i,c,h;for(console.log("choosing hall..."),Ce.play(),G=I.add.sprite(I.world.width/2,1.5*I.world.height,"hall"),o=I.add.text(0,-100,"Choose Carefully",{font:'30px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),o.renderable=!0,o.anchor.setTo(.5,.5),G.addChild(o),G.anchor.setTo(.5,.5),t=G.width-50,e=G.height-100,a=h=1;oe>=1?oe>=h:h>=oe;a=oe>=1?++h:--h)a-=1,n=parseInt(a/4),r=a%4,l=-G.width/2+72,s=-G.height/2+120,i=Math.round(t/4*r+l),c=Math.round(e/3*n+s),G.addChild(f(i,c,a+1));return d=I.add.tween(G).to({y:I.world.height/2},800,Phaser.Easing.Back.Out,!0)},f=function(e,t,o){var n,r;return r=I.add.button(e,t,"sheet",function(){return R?void 0:le(o)},this,W[o-1]+"/3",W[o-1]+"/2",W[o-1]+"/1",W[o-1]+"/2"),r.smoothed=!1,r.anchor.setTo(.5,.5),r.animations.add("onHover",[W[o-1]+"/1",W[o-1]+"/2",W[o-1]+"/3",W[o-1]+"/2"],10,!0),r.scale.setTo(2,2),r.smoothed=!1,r.trueY=t,n=I.add.text(0,10,W[o-1],{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),n.scale.setTo(.5,.5),n.smoothed=!1,n.anchor.setTo(.5,.5),r.addChild(n),r.setOverSound(T),r.setUpSound(Ce),r.events.onInputOver.add(function(){return r.play("onHover",10,!0,!1),r.doBounce=!0}),r.events.onInputOut.add(function(){return r.animations.stop(),r.doBounce=!1}),r.doBounce=!1,w.push(r),r},le=function(e){var t,o,n,r;for(console.log("chose hall"+e),R=!0,b=e-1,n=0,r=w.length;r>n;n++)t=w[n],t.setOverSound(null),t.setUpSound(null);return v=I.add.sprite(0,0,"sheet",W[e-1]+"/2"),v.scale.setTo(2,2),v.anchor.setTo(.5,.5),I.physics.arcade.enableBody(v),G.bringToTop(),v.animations.add("fly",Phaser.Animation.generateFrameNames(W[e-1]+"/",1,3,"",1),10,!0),v.body.collideWorldBounds=!0,o=I.add.tween(G).to({y:1.5*I.world.height},800,Phaser.Easing.Back.In,!0),o.onComplete.add(function(){var e,o;for(e=0,o=w.length;o>e;e++)t=w[e],t.destroy();return G.destroy()}),v.angle=0,v.revive(),me=I.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR),me.onDown.add(A),y.events.onInputDown.add(A),y.events.onInputDown.add(function(){return console.log("down pressed?")}),ce()},ce=function(){me.onDown.removeAll(),y.events.onInputDown.removeAll(),me.onDown.add(A),y.events.onInputDown.add(A),N=!1,D=!1,ue=0,pe.setText("Flappy Bird 2.2 Edition"),z.setText("TOUCH TO FLY\nFLAP bird WINGS"),F.renderable=!1,v.smoothed=!1,v.body.allowGravity=!1,v.reset(.3*I.world.width,I.world.height/2),v.angle=0,v.animations.play("fly"),Ee.removeAll(),K.removeAll()},ke=function(){N=!0,I.time.events.remove(Be),v.body.allowGravity=!0,v.body.gravity.y=o,Be=I.time.events.loop(1/i,Te),pe.setText(ue),z.renderable=!1},Ie=function(){var e,o,n,a;if(N?D?(o=I.add.tween(v).to({angle:90},100,Phaser.Easing.Bounce.Out,!0),v.body.bottom>=r+3&&(v.y=r-13,v.body.velocity.y=0,v.body.allowGravity=!1,v.body.gravity.y=0)):(v.angle=90*(t+v.body.velocity.y)/t-180,v.angle<-30&&(v.angle=-30),v.angle>80?(v.angle=90,v.animations.stop("fly"),v.frame=W[b]+"/2"):v.animations.play("fly"),I.physics.arcade.overlap(v,Ee,function(){return ve(),C.play()}),!D&&v.body.bottom>=r&&ve(),I.physics.arcade.overlap(v,K,g)):(v.y=I.world.height/2+8*Math.cos(I.time.now/200),v.angle=0),!R)for(n=0,a=w.length;a>n;n++)e=w[n],e.doBounce?e.y=e.trueY+5*Math.cos(I.time.now/200):e.y=e.trueY;D||(y.tilePosition.x-=I.time.physicsElapsed*c/5),D||(j.tilePosition.x-=I.time.physicsElapsed*c)},X=function(e){var t;return xe(),te.revive(),I.world.bringToTop(ee),t=I.add.tween(ee).to({y:I.world.height/2},800,Phaser.Easing.Back.Out,!0),t.onComplete.add(function(){return ae.addEnterCallback(function(){return Se(),V=!0,re=ae.value,t=I.add.tween(ee).to({y:1.5*I.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),t.onComplete.add(function(){return te.kill(),e()})})}),Ce.play()},ie=function(){e&&(I.debug.body(v),Ee.forEachAlive(function(e){I.debug.body(e)}),K.forEach(function(e){I.debug.body(e)}))},Pe={preload:se,create:k,update:Ie,render:ie},I=new Phaser.Game(u,a,Phaser.CANVAS,ne,Pe,!1,!1),ge=de(32,"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")},WebFontConfig={google:{families:["Press+Start+2P::latin"]},active:main},function(){var e,t;return t=document.createElement("script"),t.src=("https:"===document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",t.type="text/javascript",t.async="true",e=document.getElementsByTagName("script")[0],e.parentNode.insertBefore(t,e)}();
