...
this.dirtyUVS=!0;var x=_.texture,v=x.frame,b=x.baseTexture.width,w=x.baseTexture.height;this.uvs[c+0]=v.x/b,this.uvs[c+1]=v.y/w,this.uvs[c+2]=(v.x+v.width)/b,this.uvs[c+3]=v.y/w,this.uvs[c+4]=(v.x+v.width)/b,this.uvs[c+5]=(v.y+v.height)/w,this.uvs[c+6]=v.x/b,this.uvs[c+7]=(v.y+v.height)/w,_.updateFrame=!1}if(_.cacheAlpha!=_.worldAlpha){_.cacheAlpha=_.worldAlpha;var T=4*y;this.colors[T]=this.colors[T+1]=this.colors[T+2]=this.colors[T+3]=_.worldAlpha,this.dirtyColors=!0}}else c=8*y,this.verticies[c+0]=0,this.verticies[c+1]=0,this.verticies[c+2]=0,this.verticies[c+3]=0,this.verticies[c+4]=0,this.verticies[c+5]=0,this.verticies[c+6]=0,this.verticies[c+7]=0;y++,_=_.__next}},i});var DEBUG,FLAP,GRAVITY,GROUND_HEIGHT,GROUND_Y,HEIGHT,OPENING,SCALE,SPAWN_RATE,SPEED,WIDTH,WebFontConfig,bg,bird,buttonList,clickSnd,deadInvs,deadTubeBottoms,deadTubeTops,fallSnd,flapSnd,floor,gameOver,gameOverText,gameStarted,githubHtml,ground,hall,hallChosen,hoverSnd,hurtSnd,instText,invs,main,numHalls,parent,score,scoreSnd,scoreText,spaceKey,swooshSnd,tubes,tubesTimer;DEBUG=!1,SPEED=160,GRAVITY=1100,FLAP=320,SPAWN_RATE=1/1200,OPENING=100,SCALE=1,HEIGHT=384,WIDTH=500,GROUND_HEIGHT=64,GROUND_Y=HEIGHT-GROUND_HEIGHT,parent=document.querySelector("#screen"),gameStarted=void 0,gameOver=void 0,deadTubeTops=[],deadTubeBottoms=[],deadInvs=[],hallChosen=!1,bg=null,tubes=null,invs=null,bird=null,ground=null,hall=null,score=null,scoreText=null,instText=null,gameOverText=null,flapSnd=null,scoreSnd=null,hurtSnd=null,fallSnd=null,swooshSnd=null,hoverSnd=null,clickSnd=null,tubesTimer=null,spaceKey=null,numHalls=15,buttonList=null,githubHtml='<iframe src="http://ghbtns.com/github-btn.html?user=hyspace&repo=flappy&type=watch&count=true&size=large"\nallowtransparency="true" frameborder="0" scrolling="0" width="150" height="30"></iframe>',floor=Math.floor,main=function(){var t,e,i,s,n,r,o,a,h,l,c,u,d,p,f,g;u=function(t,e){var i,s,n;return i=null,s=e?"tubeTop":"tubeBottom",n=floor(e?t-OPENING/2-320:t+OPENING/2),deadTubeTops.length>0&&"tubeTop"===s?(i=deadTubeTops.pop().revive(),i.reset(r.world.width,n)):deadTubeBottoms.length>0&&"tubeBottom"===s?(i=deadTubeBottoms.pop().revive(),i.reset(r.world.width,n)):(i=tubes.create(r.world.width,n,s),i.body.allowGravity=!1),i.body.velocity.x=-SPEED,i},d=function(){var t,e,i,s;tubes.forEachAlive(function(t){t.x+t.width<r.world.bounds.left&&("tubeTop"===t.key&&deadTubeTops.push(t.kill()),"tubeBottom"===t.key&&deadTubeBottoms.push(t.kill()))}),invs.forEachAlive(function(t){t.x+t.width<r.world.bounds.left&&deadInvs.push(t.kill())}),s=r.world.height/2+(Math.random()-.5)*r.world.height*.2,t=u(s),i=u(s,!0),deadInvs.length>0?e=deadInvs.pop().revive().reset(i.x+i.width/2,0):(e=invs.create(i.x+i.width/2,0),e.width=2,e.height=r.world.height,e.body.allowGravity=!1),e.body.velocity.x=-SPEED},e=function(t,e){invs.remove(e),score+=1,scoreText.setText(score),scoreSnd.play()},c=function(){var t;gameOver=!0,bird.body.velocity.y>0&&(bird.body.velocity.y=100),bird.animations.stop(),bird.frame=1,instText.setText("TOUCH\nTO TRY AGAIN"),instText.renderable=!0,t=window.localStorage.getItem("hiscore"),t=t?t:score,t=score>parseInt(t,10)?score:t,window.localStorage.setItem("hiscore",t),gameOverText.setText("GAMEOVER\n\nHIGH SCORE\n\n"+t),gameOverText.renderable=!0,tubes.forEachAlive(function(t){t.body.velocity.x=0}),invs.forEach(function(t){t.body.velocity.x=0}),r.time.events.remove(tubesTimer),r.time.events.add(1e3,function(){return r.input.onTap.addOnce(function(){return l(),swooshSnd.play()}),spaceKey.onDown.addOnce(function(){return l(),swooshSnd.play()})}),hurtSnd.play()},n=function(){var t;gameStarted||p(),gameOver||(bird.body.gravity.y=0,bird.body.velocity.y=-100,t=r.add.tween(bird.body.velocity).to({y:-FLAP},25,Phaser.Easing.Bounce.In,!0),t.onComplete.add(function(){return bird.body.gravity.y=GRAVITY}),flapSnd.play())},a=function(){var t,e,i,s,n;for(s=n=1;numHalls>=1?numHalls>=n:n>=numHalls;s=numHalls>=1?++n:--n)e="bird"+s,r.load.spritesheet(e,"assets/birds/"+e+".png",36,26),i="button"+s,r.load.spritesheet(i,"assets/buttons/"+i+".png",36,26);t={spritesheet:{bird:["assets/bird.png",36,26]},image:{tubeTop:["assets/tube1.png"],tubeBottom:["assets/tube2.png"],ground:["assets/path.png"],bg:["assets/bg2.png"],hall:["assets/hall.png"]},audio:{flap:["assets/sfx_wing.mp3"],score:["assets/sfx_point.mp3"],hurt:["assets/sfx_hit.mp3"],fall:["assets/sfx_die.mp3"],swoosh:["assets/sfx_swooshing.mp3"],click:["assets/keyboard_tap.mp3"],hover:["assets/typewriter_key.mp3"]}},Object.keys(t).forEach(function(e){Object.keys(t[e]).forEach(function(i){r.load[e].apply(r.load,[i].concat(t[e][i]))})})},s=function(){var t;console.log("%chttps://github.com/hyspace/flappy","color: black; font-size: x-large"),t=window.innerWidth/window.innerHeight,(t>1.15||.7>t)&&(document.querySelector("#github").innerHTML=githubHtml),document.querySelector("#loading").style.display="none",Phaser.Canvas.setSmoothingEnabled(r.context,!1),r.stage.scaleMode=Phaser.StageScaleMode.SHOW_ALL,r.stage.scale.setScreenSize(!0),r.world.width=WIDTH,r.world.height=HEIGHT,bg=r.add.tileSprite(0,0,WIDTH,HEIGHT,"bg"),bird=r.add.sprite(0,0),tubes=r.add.group(),invs=r.add.group(),ground=r.add.tileSprite(0,GROUND_Y,WIDTH,GROUND_HEIGHT,"ground"),ground.tileScale.setTo(SCALE,SCALE),scoreText=r.add.text(r.world.width/2,r.world.height/4,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),scoreText.anchor.setTo(.5,.5),instText=r.add.text(r.world.width/2,r.world.height-r.world.height/4,"",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),instText.anchor.setTo(.5,.5),gameOverText=r.add.text(r.world.width/2,r.world.height/2,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),gameOverText.anchor.setTo(.5,.5),gameOverText.scale.setTo(SCALE,SCALE),flapSnd=r.add.audio("flap"),scoreSnd=r.add.audio("score"),hurtSnd=r.add.audio("hurt"),fallSnd=r.add.audio("fall"),swooshSnd=r.add.audio("swoosh"),hoverSnd=r.add.audio("hover"),clickSnd=r.add.audio("click"),bird.kill(),buttonList=[],i()},i=function(){var e,i,s,n,o,a,h,l,c;for(console.log("choosing hall..."),hall=r.add.sprite(r.world.width/2,1.5*r.world.height,"hall"),hall.anchor.setTo(.5,.5),i=hall.width-50,e=hall.height-100,o=c=1;numHalls>=1?numHalls>=c:c>=numHalls;o=numHalls>=1?++c:--c)o-=1,s=parseInt(o/5),n=o%5,a=-hall.width/2+62,h=-hall.height/2+100,hall.addChild(t(i/5*n+a,e/3*s+h,o+1));return l=r.add.tween(hall).to({y:r.world.height/2},800,Phaser.Easing.Back.Out,!0)},t=function(t,e,i){var s;return s=r.add.button(t,e,"button"+i,function(){return hallChosen?void 0:o(i)},this,2,1,0,1),s.anchor.setTo(.5,.5),s.animations.add("onHover",[0,1,2,1],10,!0),s.trueY=e,s.setOverSound(hoverSnd),s.setUpSound(clickSnd),s.events.onInputOver.add(function(){return s.play("onHover",10,!0,!1),s.doBounce=!0}),s.events.onInputOut.add(function(){return s.animations.stop(),s.doBounce=!1}),s.doBounce=!1,buttonList.push(s),s},o=function(t){var e,i,s,o;for(console.log("chose hall"+t),hallChosen=!0,s=0,o=buttonList.length;o>s;s++)e=buttonList[s],e.setOverSound(null),e.setUpSound(null);return bird=r.add.sprite(0,0,"bird"+t),hall.bringToTop(),bird.anchor.setTo(.5,.5),bird.animations.add("fly",[0,1,2,1],10,!0),bird.body.collideWorldBounds=!0,bird.body.setPolygon(24,1,34,16,30,32,20,24,12,34,2,12,14,2),i=r.add.tween(hall).to({y:1.5*r.world.height},800,Phaser.Easing.Back.In,!0),i.onComplete.add(function(){var t,i;for(t=0,i=buttonList.length;i>t;t++)e=buttonList[t],e.destroy();return hall.destroy()}),bird.revive(),spaceKey=r.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR),spaceKey.onDown.add(n),r.input.onDown.add(n),l()},l=function(){spaceKey.onDown.removeAll(),r.input.onTap.removeAll(),spaceKey.onDown.add(n),gameStarted=!1,gameOver=!1,score=0,scoreText.setText("Flappy Bird"),instText.setText("TOUCH TO fuck you\nbird WINGS"),gameOverText.renderable=!1,bird.body.allowGravity=!1,bird.reset(.3*r.world.width,r.world.height/2),bird.angle=0,bird.animations.play("fly"),tubes.removeAll(),invs.removeAll()},p=function(){gameStarted=!0,bird.body.allowGravity=!0,bird.body.gravity.y=GRAVITY,tubesTimer=r.time.events.loop(1/SPAWN_RATE,d),scoreText.setText(score),instText.renderable=!1},g=function(){var t,i,s,n;if(gameStarted?gameOver?(i=r.add.tween(bird).to({angle:90},100,Phaser.Easing.Bounce.Out,!0),bird.body.bottom>=GROUND_Y+3&&(bird.y=GROUND_Y-13,bird.body.velocity.y=0,bird.body.allowGravity=!1,bird.body.gravity.y=0)):(bird.angle=90*(FLAP+bird.body.velocity.y)/FLAP-180,bird.angle<-30&&(bird.angle=-30),bird.angle>80?(bird.angle=90,bird.animations.stop(),bird.frame=1):bird.animations.play(),r.physics.overlap(bird,tubes,function(){return c(),fallSnd.play()}),!gameOver&&bird.body.bottom>=GROUND_Y&&c(),r.physics.overlap(bird,invs,e)):(bird.y=r.world.height/2+8*Math.cos(r.time.now/200),bird.angle=0),!hallChosen)for(s=0,n=buttonList.length;n>s;s++)t=buttonList[s],t.doBounce?t.y=t.trueY+5*Math.cos(r.time.now/200):t.y=t.trueY;gameOver||(bg.tilePosition.x-=r.time.physicsElapsed*SPEED/5),gameOver||(ground.tilePosition.x-=r.time.physicsElapsed*SPEED)},h=function(){DEBUG&&(r.debug.renderSpriteBody(bird),tubes.forEachAlive(function(t){r.debug.renderSpriteBody(t)}),invs.forEach(function(t){r.debug.renderSpriteBody(t)}))},f={preload:a,create:s,update:g,render:h},r=new Phaser.Game(WIDTH,HEIGHT,Phaser.CANVAS,parent,f,!1,!1)},WebFontConfig={google:{families:["Press+Start+2P::latin"]},active:main},function(){var t,e;return e=document.createElement("script"),e.src=("https:"===document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",e.type="text/javascript",e.async="true",t=document.getElementsByTagName("script")[0],t.parentNode.insertBefore(e,t)}();