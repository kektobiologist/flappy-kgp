var WebFontConfig,main;main=function(){var e,t,n,o,r,a,l,d,s,i,c,h,u,f,p,g,y,v,w,m,b,k,T,x,P,S,C,A,E,I,B,D,M,O,H,_,F,N,L,j,G,R,W,q,U,Y,K,V,z,J,Z,Q,X,ee,te,ne,oe,re,ae,le,de,se,ie,ce,he,ue,fe,pe,ge,ye,ve,we,me,be,ke,Te,xe,Pe,Se,Ce,Ae,Ee,Ie,Be;h="flappy",e=!1,c=160,n=1100,t=320,i=1/1200,d=100,s=1,l=6,a=384,u=500,o=64,r=a-o,oe=document.querySelector("#screen"),N=void 0,D=void 0,S=[],P=[],x=[],J=[{name:"Arpit",score:"58",hall:"AZ"},{name:"Apoorv",score:"2",hall:"NH"},{name:"Vikrant",score:"1",hall:"RP"},{name:"Arkanath",score:"100",hall:"MS"}],W=["AZ","MT","RP","SN","NH","PT","RK","LLR","MS","LBS","MMM","HJB"],b=null,z=!1,R=!1,y=null,Ee=null,V=null,v=null,j=null,G=null,M=null,te=null,Z=null,ee=null,ge=null,re=null,ue=null,pe=null,K=null,F=null,Ae=null,H=null,_=null,ae=null,E=null,fe=null,Y=null,C=null,Ce=null,U=null,k=null,Ie=null,me=null,ne=12,w=null,Q=null,L='<iframe src="http://ghbtns.com/github-btn.html?user=korroktheslavemaster&repo=flappy-kgp&type=watch&count=true&size=large"\nallowtransparency="true" frameborder="0" scrolling="0" width="150" height="30"></iframe>',I=Math.floor,se=function(e,t){var n,o,r;for(o="",n=r=e;1>=e?1>=r:r>=1;n=1>=e?++r:--r)o+=t[Math.floor(Math.random()*t.length)];return o},be=function(e,t){var n,o,r;return n=null,o=t?"tubeTop":"tubeBottom",r=I(t?e-d/2-320:e+d/2),S.length>0&&"tubeTop"===o?(n=S.pop().revive(),n.reset(B.world.width,r)):P.length>0&&"tubeBottom"===o?(n=P.pop().revive(),n.reset(B.world.width,r)):(n=Ee.create(B.world.width,r,o),B.physics.arcade.enableBody(n),n.body.allowGravity=!1),n.body.velocity.x=-c,n},ke=function(){var e,t,n,o;Ee.forEachAlive(function(e){e.x+e.width<B.world.bounds.left&&("tubeTop"===e.key&&S.push(e.kill()),"tubeBottom"===e.key&&P.push(e.kill()))}),V.forEachAlive(function(e){e.x+e.width<B.world.bounds.left&&x.push(e.kill())}),o=B.world.height/2+(Math.random()-.5)*B.world.height*.2,e=be(o),n=be(o,!0),x.length>0?t=x.pop().revive().reset(n.x+n.width/2,0):(t=V.create(n.x+n.width/2,0),B.physics.arcade.enableBody(t),t.width=2,t.height=B.world.height,t.body.allowGravity=!1),t.body.velocity.x=-c},g=function(e,t){V.remove(t),ue+=1,pe.setText(ue),fe.play()},he=function(){for(J.sort(function(e,t){return parseInt(e.score)<parseInt(t.score)});J.length<l;)J.push({name:"---",score:"-1",hall:"DUMMY2"});return J},ye=function(){var e;return e={score:ue,name:re,hall:W[b],key:ge,token:q(ue+ge+h+ue)},$.ajax({type:"POST",data:e,dataType:"text",url:"/sendScore",success:function(e){},error:function(){}})},we=function(){var e,t;return e=ye(),Q.input.enabled=!1,M.alive?(t=B.add.tween(M).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),me.onDown.removeAll(),y.events.onInputDown.removeAll(),t.onComplete.add(function(){var n,o,r,a,l,d,s;for(M.kill(),Z.revive(),Z.bringToTop(),t=B.add.tween(Z).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),r="",o="",a="",Z.children[1].setText("Loading.."),Z.children[2].setText(""),Z.children[0].setText(""),l=d=3,s=Z.children.length-1;s>=3?s>=d:d>=s;l=s>=3?++d:--d)Z.children[l].kill();return n=function(){var e,t,n,l;for(t=n=0,l=J.length-1;l>=0?l>=n:n>=l;t=l>=0?++n:--n)J[t].score<0?(r+="\n-",o+="\n---",a+="\n---",Z.children[3+t].kill()):(r+="\n"+(t+1),o+="\n"+J[t].name,a+="\n"+J[t].score,e=Z.children[3+t],e.revive(),e.frameName=J[t].hall+"/2",e.children[0].setText(J[t].hall));return Z.children[0].setText(r),Z.children[1].setText(o),Z.children[2].setText(a)},$.when(e).done(function(e){return $.ajax({type:"GET",url:"/getLeaderboard",success:function(e){return J=e,he(),n()},error:function(){return J=[],he(),n()}})}),t.onComplete.add(function(){var e;return e=function(){return Z.alive?(t=B.add.tween(Z).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),me.onDown.removeAll(),y.events.onInputDown.removeAll(),t.onComplete.add(function(){return Z.kill(),ce()})):ce()},y.events.onInputDown.addOnce(e),me.onDown.addOnce(e)})})):void 0},p=function(e,t,n){var o;return o=B.add.sprite(e,t,"sheet",W[n]+"/2"),o.scale.setTo(2,2),o.smoothed=!1,o.anchor.setTo(.5,.5),o},xe=function(){return y.inputEnabled=!1,me.onDown.removeAll(),ae.startFocus(),ae.focus=!0,ae.placeHolder.visible=!1},Se=function(){return ae.endFocus(),ae.focus=!1,y.inputEnabled=!0},O=function(){var e;return me.onDown.removeAll(),y.events.onInputDown.removeAll(),M.revive(),Q.input.enabled=!1,M.bringToTop(),e=B.add.tween(M).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),e.onComplete.add(function(){var t;return Q.input.enabled=!0,t=function(){return ye(),Q.input.enabled=!1,M.alive?(e=B.add.tween(M).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),me.onDown.removeAll(),y.events.onInputDown.removeAll(),e.onComplete.add(function(){return M.kill(),ce()})):ce()},y.events.onInputDown.addOnce(t),me.onDown.addOnce(t)}),Ce.play()},ve=function(){var e;D=!0,v.body.velocity.y>0&&(v.body.velocity.y=100),v.animations.stop(),v.frame=W[b]+"/2",e=window.localStorage.getItem("hiscore"),e=e?e:ue,e=ue>parseInt(e,10)?ue:e,window.localStorage.setItem("hiscore",e),H.setText(ue),_.setText(e),Ee.forEachAlive(function(e){e.body.velocity.x=0}),V.forEach(function(e){e.body.velocity.x=0}),B.time.events.remove(Ie),B.time.events.add(1e3,function(){return z?O():X(O)}),Y.play()},A=function(){var e;N||Te(),D||(v.body.gravity.y=0,v.body.velocity.y=-100,e=B.add.tween(v.body.velocity).to({y:-t},25,Phaser.Easing.Bounce.In,!0),e.onComplete.add(function(){return v.body.gravity.y=n}),E.play())},de=function(){var e;B.load.atlasJSONHash("sheet","assets/sheet.png","assets/sheet.json"),e={spritesheet:{leaderboard:["assets/leaderboard.png",52,29]},image:{tubeTop:["assets/tube1.png"],tubeBottom:["assets/tube2.png"],ground:["assets/path.png"],bg:["assets/bg2.png"],hall:["assets/hall.png"],gameover:["assets/gameover-panel.png"],lbPanel:["assets/lbPanel.png"],nameScreen:["assets/name.png"]},audio:{flap:["assets/sfx_wing.mp3"],score:["assets/sfx_point.mp3"],hurt:["assets/sfx_hit.mp3"],fall:["assets/sfx_die.mp3"],swoosh:["assets/sfx_swooshing.mp3"],click:["assets/keyboard_tap.mp3"],hover:["assets/typewriter_key.mp3"]}},Object.keys(e).forEach(function(t){Object.keys(e[t]).forEach(function(n){B.load[t].apply(B.load,[n].concat(e[t][n]))})})},q=function(e){var t,n,o,r,a,l;if(n=0,0===e.length)return n;for(r=e.length,o=a=0,l=r-1;l>=0?l>=a:a>=l;o=l>=0?++a:--a)t=e.charCodeAt(o),n=(n<<5)-n+t,n|=0;return n},T=function(){var e,t,n,d,i,c,h,f,g,b,T,x,P,S,A,I,D;for(B.add.plugin(Fabrique.Plugins.InputField),d=window.localStorage.getItem("name"),d&&(z=!0,re=d),B.physics.startSystem(Phaser.Physics.ARCADE),h=window.innerWidth/window.innerHeight,(h>1.15||.7>h)&&(document.querySelector("#github").innerHTML=L),document.querySelector("#loading").style.display="none",B.scale.pageAlignVertically=!0,B.smoothed=!1,B.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,B.scale.windowConstraints.bottom="visual",B.scale.setGameSize(u,a),y=B.add.tileSprite(0,0,u,a,"bg"),y.smoothed=!0,y.inputEnabled=!0,y.input.priorityID=0,v=B.add.sprite(0,0),Ee=B.add.group(),V=B.add.group(),ee=B.add.group(void 0,void 0,!1,!0,Phaser.Physics.ARCADE),j=B.add.tileSprite(0,r,u,o,"ground"),j.tileScale.setTo(s,s),pe=B.add.text(B.world.width/2,B.world.height/4,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),pe.anchor.setTo(.5,.5),K=B.add.text(B.world.width/2,B.world.height-B.world.height/4,"",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),K.anchor.setTo(.5,.5),F=B.add.text(B.world.width/2,B.world.height/2,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),F.anchor.setTo(.5,.5),F.scale.setTo(s,s),Z=B.add.sprite(B.world.width/2,1.5*B.world.height,"lbPanel"),Z.anchor.setTo(.5,.5),Z.kill(),T=B.add.text(-170,-10,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),T.anchor.setTo(.5,.5),b=B.add.text(20,-10,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),b.anchor.setTo(.5,.5),x=B.add.text(150,-10,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"right"}),x.anchor.setTo(.5,.5),I=[T,b,x],P=0,A=I.length;A>P;P++)g=I[P],g.lineSpacing=15;for(Z.addChild(T),Z.addChild(b),Z.addChild(x),n=S=0,D=l-1;D>=0?D>=S:S>=D;n=D>=0?++S:--S)f=p(-120,-105+41*n,0),e=B.add.text(0,10,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),e.scale.setTo(.5,.5),e.smoothed=!1,e.anchor.setTo(.5,.5),f.addChild(e),f.kill(),Z.addChild(f);te=B.add.sprite(0,0,"nameScreen",void 0,ee),te.anchor.setTo(.5,.5),te.kill(),ee.x=B.world.width/2,ee.y=1.5*B.world.height,M=B.add.sprite(B.world.width/2,1.5*B.world.height,"gameover"),M.anchor.setTo(.5,.5),M.kill(),Ae=B.add.text(0,M.height/2-20,"Touch to Try Again",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),Ae.anchor.setTo(.5,.5),M.addChild(Ae),t=t=B.add.text(M.width/4-10,-30,"Score\n\nBest",{font:'24px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),t.anchor.setTo(0,0),M.addChild(t),H=B.add.text(M.width/4-10,0,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),H.anchor.setTo(0,0),M.addChild(H),_=B.add.text(M.width/4-10,68,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),_.anchor.setTo(0,0),M.addChild(_),Q=B.add.button(-100,0,"leaderboard",we,this,0,0,1),Q.events.onInputUp.add(function(){return k.play()}),Q.scale.setTo(2,2),Q.anchor.setTo(.5,.5),Q.smoothed=!1,M.addChild(Q),c=B.add.text(0,-30,"Enter Name",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),c.anchor.setTo(.5,.5),te.addChild(c),i=B.add.text(0,60,"Press Enter to continue",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),i.anchor.setTo(.5,.5),te.addChild(i),ae=B.add.inputField(-75,10,{font:'16px "Press Start 2P"',fill:"#430",cursorColor:"#430",backgroundColor:"#ffffff",placeHolder:"name",placeHolderColor:"#874",height:30,width:150,type:Fabrique.InputType.text},ee),ae.anchor.setTo(0,.3),ae.bringToTop(),E=B.add.audio("flap"),E.allowMultiple=!0,fe=B.add.audio("score"),Y=B.add.audio("hurt"),C=B.add.audio("fall"),Ce=B.add.audio("swoosh"),U=B.add.audio("hover"),k=B.add.audio("click"),v.kill(),w=[],m()},m=function(){var e,t,n,o,r,a,l,d,s,i,c,h;for(Ce.play(),G=B.add.sprite(B.world.width/2,1.5*B.world.height,"hall"),n=B.add.text(0,-100,"Choose Carefully",{font:'30px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),n.renderable=!0,n.anchor.setTo(.5,.5),G.addChild(n),G.anchor.setTo(.5,.5),t=G.width-50,e=G.height-100,a=h=1;ne>=1?ne>=h:h>=ne;a=ne>=1?++h:--h)a-=1,o=parseInt(a/4),r=a%4,l=-G.width/2+72,d=-G.height/2+120,i=Math.round(t/4*r+l),c=Math.round(e/3*o+d),G.addChild(f(i,c,a+1));return s=B.add.tween(G).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0)},f=function(e,t,n){var o,r;return r=B.add.button(e,t,"sheet",function(){return R?void 0:le(n)},this,W[n-1]+"/3",W[n-1]+"/2",W[n-1]+"/1",W[n-1]+"/2"),r.smoothed=!1,r.anchor.setTo(.5,.5),r.animations.add("onHover",[W[n-1]+"/1",W[n-1]+"/2",W[n-1]+"/3",W[n-1]+"/2"],10,!0),r.scale.setTo(2,2),r.smoothed=!1,r.trueY=t,o=B.add.text(0,10,W[n-1],{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),o.scale.setTo(.5,.5),o.smoothed=!1,o.anchor.setTo(.5,.5),r.addChild(o),r.setOverSound(k),r.setUpSound(Ce),r.events.onInputOver.add(function(){return r.play("onHover",10,!0,!1),r.doBounce=!0}),r.events.onInputOut.add(function(){return r.animations.stop(),r.doBounce=!1}),r.doBounce=!1,w.push(r),r},le=function(e){var t,n,o,r;for(R=!0,b=e-1,o=0,r=w.length;r>o;o++)t=w[o],t.setOverSound(null),t.setUpSound(null);return v=B.add.sprite(0,0,"sheet",W[e-1]+"/2"),v.scale.setTo(2,2),v.anchor.setTo(.5,.5),B.physics.arcade.enableBody(v),G.bringToTop(),v.animations.add("fly",Phaser.Animation.generateFrameNames(W[e-1]+"/",1,3,"",1),10,!0),v.body.collideWorldBounds=!0,n=B.add.tween(G).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),n.onComplete.add(function(){var e,n;for(e=0,n=w.length;n>e;e++)t=w[e],t.destroy();return G.destroy()}),v.angle=0,v.revive(),me=B.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR),me.onDown.add(A),y.events.onInputDown.add(A),y.events.onInputDown.add(function(){}),ce()},ce=function(){me.onDown.removeAll(),y.events.onInputDown.removeAll(),me.onDown.add(A),y.events.onInputDown.add(A),N=!1,D=!1,ue=0,pe.setText("Flappy Bird 2.2 Edition"),K.setText("TOUCH TO FLY\nFLAP bird WINGS"),F.renderable=!1,v.smoothed=!1,v.body.allowGravity=!1,v.reset(.3*B.world.width,B.world.height/2),v.angle=0,v.animations.play("fly"),Ee.removeAll(),V.removeAll()},Te=function(){N=!0,B.time.events.remove(Ie),v.body.allowGravity=!0,v.body.gravity.y=n,Ie=B.time.events.loop(1/i,ke),pe.setText(ue),K.renderable=!1},Be=function(){var e,n,o,a;if(N?D?(n=B.add.tween(v).to({angle:90},100,Phaser.Easing.Bounce.Out,!0),v.body.bottom>=r+3&&(v.y=r-13,v.body.velocity.y=0,v.body.allowGravity=!1,v.body.gravity.y=0)):(v.angle=90*(t+v.body.velocity.y)/t-180,v.angle<-30&&(v.angle=-30),v.angle>80?(v.angle=90,v.animations.stop("fly"),v.frame=W[b]+"/2"):v.animations.play("fly"),B.physics.arcade.overlap(v,Ee,function(){return ve(),C.play()}),!D&&v.body.bottom>=r&&ve(),B.physics.arcade.overlap(v,V,g)):(v.y=B.world.height/2+8*Math.cos(B.time.now/200),v.angle=0),!R)for(o=0,a=w.length;a>o;o++)e=w[o],e.doBounce?e.y=e.trueY+5*Math.cos(B.time.now/200):e.y=e.trueY;D||(y.tilePosition.x-=B.time.physicsElapsed*c/5),D||(j.tilePosition.x-=B.time.physicsElapsed*c)},X=function(e){var t;return xe(),te.revive(),B.world.bringToTop(ee),t=B.add.tween(ee).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),t.onComplete.add(function(){return ae.addEnterCallback(function(){return Se(),z=!0,re=ae.value,window.localStorage.setItem("name",re),t=B.add.tween(ee).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ce.play(),t.onComplete.add(function(){return te.kill(),e()})})}),Ce.play()},ie=function(){e&&(B.debug.body(v),Ee.forEachAlive(function(e){B.debug.body(e)}),V.forEach(function(e){B.debug.body(e)}))},Pe={preload:de,create:T,update:Be,render:ie},B=new Phaser.Game(u,a,Phaser.CANVAS,oe,Pe,!1,!1),ge=se(32,"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")},WebFontConfig={google:{families:["Press+Start+2P::latin"]},active:main},function(){var e,t;return t=document.createElement("script"),t.src=("https:"===document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",t.type="text/javascript",t.async="true",e=document.getElementsByTagName("script")[0],e.parentNode.insertBefore(t,e)}();
