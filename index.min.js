var WebFontConfig,main;main=function(){var e,t,n,o,r,a,l,i,d,s,h,c,u,f,p,g,v,y,w,m,b,T,k,x,P,S,C,A,E,I,B,D,O,M,H,_,F,N,L,j,G,R,U,W,Y,q,K,V,z,J,Z,Q,X,ee,te,ne,oe,re,ae,le,ie,de,se,he,ce,ue,fe,pe,ge,ve,ye,we,me,be,Te,ke,xe,Pe,Se,Ce,Ae,Ee,Ie,Be,De;c="flappy",e=!1,h=160,n=1100,t=320,s=1/1200,i=100,d=1,l=6,a=384,u=500,o=64,r=a-o,ne=document.querySelector("#screen"),N=void 0,D=void 0,S=[],P=[],x=[],z=[{name:"Arpit",score:"58",hall:"AZ"},{name:"Apoorv",score:"2",hall:"NH"},{name:"Vikrant",score:"1",hall:"RP"},{name:"Arkanath",score:"100",hall:"MS"}],R=["AZ","MT","RP","SN","NH","PT","RK","LLR","MS","LBS","MMM","HJB"],b=null,V=!1,G=!1,v=null,Ie=null,K=null,y=null,L=null,j=null,O=null,ee=null,J=null,X=null,pe=null,oe=null,ce=null,fe=null,q=null,F=null,Ee=null,H=null,_=null,re=null,E=null,ue=null,Y=null,C=null,Ae=null,W=null,T=null,Be=null,be=null,te=12,w=null,Z=null,I=Math.floor,ie=function(e,t){var n,o,r;for(o="",n=r=e;1>=e?1>=r:r>=1;n=1>=e?++r:--r)o+=t[Math.floor(Math.random()*t.length)];return o},Te=function(e,t){var n,o,r;return n=null,o=t?"tubeTop":"tubeBottom",r=I(t?e-i/2-320:e+i/2),S.length>0&&"tubeTop"===o?(n=S.pop().revive(),n.reset(B.world.width,r)):P.length>0&&"tubeBottom"===o?(n=P.pop().revive(),n.reset(B.world.width,r)):(n=Ie.create(B.world.width,r,o),B.physics.arcade.enableBody(n),n.body.allowGravity=!1),n.body.velocity.x=-h,n},ke=function(){var e,t,n,o;Ie.forEachAlive(function(e){e.x+e.width<B.world.bounds.left&&("tubeTop"===e.key&&S.push(e.kill()),"tubeBottom"===e.key&&P.push(e.kill()))}),K.forEachAlive(function(e){e.x+e.width<B.world.bounds.left&&x.push(e.kill())}),o=B.world.height/2+(Math.random()-.5)*B.world.height*.2,e=Te(o),n=Te(o,!0),x.length>0?t=x.pop().revive().reset(n.x+n.width/2,0):(t=K.create(n.x+n.width/2,0),B.physics.arcade.enableBody(t),t.width=2,t.height=B.world.height,t.body.allowGravity=!1),t.body.velocity.x=-h},g=function(e,t){K.remove(t),ce+=1,fe.setText(ce),ue.play()},ye=function(e){var t,n,o,r,a,l,i;for(o="",n="",r="",J.children[1].setText("Loading.."),J.children[2].setText(""),J.children[0].setText(""),a=l=3,i=J.children.length-1;i>=3?i>=l:l>=i;a=i>=3?++l:--l)J.children[a].kill();return J.children[9].revive(),J.children[10].revive(),t=function(){var e,t,a,l;for(t=a=0,l=z.length-1;l>=0?l>=a:a>=l;t=l>=0?++a:--a)z[t].score<0?(o+="\n-",n+="\n---",r+="\n---",J.children[3+t].kill()):(o+="\n"+(t+1),n+="\n"+z[t].hall,r+="\n"+z[t].score,e=J.children[3+t],e.revive(),e.frameName=z[t].hall+"/2",e.children[0].setText(z[t].hall));return J.children[0].setText(o),J.children[1].setText(n),J.children[2].setText(r),J.children[9].bringToTop()},$.when(e).done(function(e){return $.ajax({type:"GET",url:"/getLeaderboardHall",success:function(e){return z=e,he(),t()},error:function(){return z=[],he(),t()}})})},we=function(e){var t,n,o,r,a,l,i;for(o="",n="",r="",J.children[1].setText("Loading.."),J.children[2].setText(""),J.children[0].setText(""),a=l=3,i=J.children.length-1;i>=3?i>=l:l>=i;a=i>=3?++l:--l)J.children[a].kill();return J.children[9].revive(),J.children[10].revive(),t=function(){var e,t,a,l;for(t=a=0,l=z.length-1;l>=0?l>=a:a>=l;t=l>=0?++a:--a)z[t].score<0?(o+="\n-",n+="\n---",r+="\n---",J.children[3+t].kill()):(o+="\n"+(t+1),n+="\n"+z[t].name,r+="\n"+z[t].score,e=J.children[3+t],e.revive(),e.frameName=z[t].hall+"/2",e.children[0].setText(z[t].hall));return J.children[0].setText(o),J.children[1].setText(n),J.children[2].setText(r),J.children[9].bringToTop()},$.when(e).done(function(e){return $.ajax({type:"GET",url:"/getLeaderboardSolo",success:function(e){return z=e,he(),t()},error:function(){return z=[],he(),t()}})})},he=function(){for(z.sort(function(e,t){return parseInt(e.score)<parseInt(t.score)});z.length<l;)z.push({name:"---",score:"-1",hall:"DUMMY2"});return z},ge=function(){var e;return e={score:ce,name:oe,hall:R[b],key:pe,token:U(ce+pe+c+ce)},$.ajax({type:"POST",data:e,dataType:"text",url:"/sendScore",success:function(e){},error:function(){}})},me=function(){var e,t;return J.frame=0,e=ge(),Z.input.enabled=!1,O.alive?(t=B.add.tween(O).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ae.play(),be.onDown.removeAll(),v.events.onInputDown.removeAll(),t.onComplete.add(function(){return O.kill(),J.revive(),J.bringToTop(),t=B.add.tween(J).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),ye(e),t.onComplete.add(function(){var e;return e=function(){return J.alive?(t=B.add.tween(J).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ae.play(),be.onDown.removeAll(),v.events.onInputDown.removeAll(),t.onComplete.add(function(){return J.kill(),se()})):se()},v.events.onInputDown.addOnce(e),be.onDown.addOnce(e)})})):void 0},p=function(e,t,n){var o;return o=B.add.sprite(e,t,"sheet",R[n]+"/2"),o.scale.setTo(2,2),o.smoothed=!1,o.anchor.setTo(.5,.5),o},Pe=function(){return v.inputEnabled=!1,be.onDown.removeAll(),re.startFocus(),re.focus=!0,re.placeHolder.visible=!1},Ce=function(){return re.endFocus(),re.focus=!1,v.inputEnabled=!0},M=function(){var e;return be.onDown.removeAll(),v.events.onInputDown.removeAll(),O.revive(),Z.input.enabled=!1,O.bringToTop(),e=B.add.tween(O).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),e.onComplete.add(function(){var t;return Z.input.enabled=!0,t=function(){return ge(),Z.input.enabled=!1,O.alive?(e=B.add.tween(O).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ae.play(),be.onDown.removeAll(),v.events.onInputDown.removeAll(),e.onComplete.add(function(){return O.kill(),se()})):se()},v.events.onInputDown.addOnce(t),be.onDown.addOnce(t)}),Ae.play()},ve=function(){var e;D=!0,y.body.velocity.y>0&&(y.body.velocity.y=100),y.animations.stop(),y.frame=R[b]+"/2",e=window.localStorage.getItem("hiscore"),e=e?e:ce,e=ce>parseInt(e,10)?ce:e,window.localStorage.setItem("hiscore",e),H.setText(ce),_.setText(e),Ie.forEachAlive(function(e){e.body.velocity.x=0}),K.forEach(function(e){e.body.velocity.x=0}),B.time.events.remove(Be),B.time.events.add(1e3,function(){return V?M():Q(M)}),Y.play()},A=function(){var e;N||xe(),D||(y.body.gravity.y=0,y.body.velocity.y=-100,e=B.add.tween(y.body.velocity).to({y:-t},25,Phaser.Easing.Bounce.In,!0),e.onComplete.add(function(){return y.body.gravity.y=n}),E.play())},le=function(){var e;B.load.atlasJSONHash("sheet","assets/sheet.png","assets/sheet.json"),e={spritesheet:{leaderboard:["assets/leaderboard.png",52,29],lbPanel:["assets/lbPanel.png",448,320]},image:{tubeTop:["assets/tube1.png"],tubeBottom:["assets/tube2.png"],ground:["assets/path.png"],bg:["assets/bg2.png"],hall:["assets/hall.png"],gameover:["assets/gameover-panel.png"],nameScreen:["assets/name.png"]},audio:{flap:["assets/sfx_wing.mp3"],score:["assets/sfx_point.mp3"],hurt:["assets/sfx_hit.mp3"],fall:["assets/sfx_die.mp3"],swoosh:["assets/sfx_swooshing.mp3"],click:["assets/keyboard_tap.mp3"],hover:["assets/typewriter_key.mp3"]}},Object.keys(e).forEach(function(t){Object.keys(e[t]).forEach(function(n){B.load[t].apply(B.load,[n].concat(e[t][n]))})})},U=function(e){var t,n,o,r,a,l;if(n=0,0===e.length)return n;for(r=e.length,o=a=0,l=r-1;l>=0?l>=a:a>=l;o=l>=0?++a:--a)t=e.charCodeAt(o),n=(n<<5)-n+t,n|=0;return n},k=function(){var e,t,n,i,s,h,c,f,g,b,k,x,P,S,A,I,D,M,N;for(B.add.plugin(Fabrique.Plugins.InputField),h=window.localStorage.getItem("name"),h&&(V=!0,oe=h),B.physics.startSystem(Phaser.Physics.ARCADE),console.log("%chttps://github.com/korroktheslavemaster/flappy-kgp","color: black; font-size: x-large"),g=window.innerWidth/window.innerHeight,document.querySelector("#loading").style.display="none",B.scale.pageAlignVertically=!0,B.smoothed=!1,B.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,B.scale.windowConstraints.bottom="visual",B.scale.setGameSize(u,a),v=B.add.tileSprite(0,0,u,a,"bg"),v.smoothed=!0,v.inputEnabled=!0,v.input.priorityID=0,y=B.add.sprite(0,0),Ie=B.add.group(),K=B.add.group(),X=B.add.group(void 0,void 0,!1,!0,Phaser.Physics.ARCADE),L=B.add.tileSprite(0,r,u,o,"ground"),L.tileScale.setTo(d,d),fe=B.add.text(B.world.width/2,B.world.height/4,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),fe.anchor.setTo(.5,.5),q=B.add.text(B.world.width/2,B.world.height-B.world.height/4,"",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),q.anchor.setTo(.5,.5),F=B.add.text(B.world.width/2,B.world.height/2,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),F.anchor.setTo(.5,.5),F.scale.setTo(d,d),J=B.add.sprite(B.world.width/2,1.5*B.world.height,"lbPanel",0),J.anchor.setTo(.5,.5),J.kill(),P=B.add.text(-170,0,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),P.anchor.setTo(.5,.5),x=B.add.text(20,0,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),x.anchor.setTo(.5,.5),S=B.add.text(150,0,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"right"}),S.anchor.setTo(.5,.5),M=[P,x,S],A=0,D=M.length;D>A;A++)k=M[A],k.lineSpacing=15;for(J.addChild(P),J.addChild(x),J.addChild(S),s=I=0,N=l-1;N>=0?N>=I:I>=N;s=N>=0?++I:--I)b=p(-120,-105+41*s+10,0),n=B.add.text(0,10,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),n.scale.setTo(.5,.5),n.smoothed=!1,n.anchor.setTo(.5,.5),b.addChild(n),b.kill(),J.addChild(b);e=B.add.button(0-J.width/2,0-J.height/2,void 0,function(){return J.frame=0,ye(void 0)},this),e.events.onInputUp.add(function(){return T.play()}),e.width=100,e.height=33,t=B.add.button(104-J.width/2,0-J.height/2,void 0,function(){return J.frame=1,we(void 0)},this),t.events.onInputUp.add(function(){return T.play()}),t.width=100,t.height=33,e.bringToTop(),t.bringToTop(),J.addChild(e),J.addChild(t),ee=B.add.sprite(0,0,"nameScreen",void 0,X),ee.anchor.setTo(.5,.5),ee.kill(),X.x=B.world.width/2,X.y=1.5*B.world.height,O=B.add.sprite(B.world.width/2,1.5*B.world.height,"gameover"),O.anchor.setTo(.5,.5),O.kill(),Ee=B.add.text(0,O.height/2-20,"Touch to Try Again",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),Ee.anchor.setTo(.5,.5),O.addChild(Ee),i=i=B.add.text(O.width/4-10,-30,"Score\n\nBest",{font:'24px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),i.anchor.setTo(0,0),O.addChild(i),H=B.add.text(O.width/4-10,0,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),H.anchor.setTo(0,0),O.addChild(H),_=B.add.text(O.width/4-10,68,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),_.anchor.setTo(0,0),O.addChild(_),Z=B.add.button(-100,0,"leaderboard",me,this,2,0,1,0),Z.events.onInputUp.add(function(){return T.play()}),Z.events.onInputOver.add(function(){return W.play()}),Z.scale.setTo(2,2),Z.anchor.setTo(.5,.5),Z.smoothed=!1,O.addChild(Z),f=B.add.text(0,-30,"Enter Name",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),f.anchor.setTo(.5,.5),ee.addChild(f),c=B.add.text(0,60,"Press Enter to continue",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),c.anchor.setTo(.5,.5),ee.addChild(c),re=B.add.inputField(-75,10,{font:'16px "Press Start 2P"',fill:"#430",cursorColor:"#430",backgroundColor:"#ffffff",placeHolder:"name",placeHolderColor:"#874",height:30,width:150,type:Fabrique.InputType.text},X),re.anchor.setTo(0,.3),re.bringToTop(),E=B.add.audio("flap"),E.allowMultiple=!0,ue=B.add.audio("score"),Y=B.add.audio("hurt"),C=B.add.audio("fall"),Ae=B.add.audio("swoosh"),W=B.add.audio("hover"),T=B.add.audio("click"),y.kill(),w=[],m()},m=function(){var e,t,n,o,r,a,l,i,d,s,h,c;for(Ae.play(),j=B.add.sprite(B.world.width/2,1.5*B.world.height,"hall"),n=B.add.text(0,-100,"Choose Carefully",{font:'30px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),n.renderable=!0,n.anchor.setTo(.5,.5),j.addChild(n),j.anchor.setTo(.5,.5),t=j.width-50,e=j.height-100,a=c=1;te>=1?te>=c:c>=te;a=te>=1?++c:--c)a-=1,o=parseInt(a/4),r=a%4,l=-j.width/2+72,i=-j.height/2+120,s=Math.round(t/4*r+l),h=Math.round(e/3*o+i),j.addChild(f(s,h,a+1));return d=B.add.tween(j).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0)},f=function(e,t,n){var o,r;return r=B.add.button(e,t,"sheet",function(){return G?void 0:ae(n)},this,R[n-1]+"/3",R[n-1]+"/2",R[n-1]+"/1",R[n-1]+"/2"),r.smoothed=!1,r.anchor.setTo(.5,.5),r.animations.add("onHover",[R[n-1]+"/1",R[n-1]+"/2",R[n-1]+"/3",R[n-1]+"/2"],10,!0),r.scale.setTo(2,2),r.smoothed=!1,r.trueY=t,o=B.add.text(0,10,R[n-1],{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),o.scale.setTo(.5,.5),o.smoothed=!1,o.anchor.setTo(.5,.5),r.addChild(o),r.setOverSound(T),r.setUpSound(Ae),r.events.onInputOver.add(function(){return r.play("onHover",10,!0,!1),r.doBounce=!0}),r.events.onInputOut.add(function(){return r.animations.stop(),r.doBounce=!1}),r.doBounce=!1,w.push(r),r},ae=function(e){var t,n,o,r;for(G=!0,b=e-1,o=0,r=w.length;r>o;o++)t=w[o],t.setOverSound(null),t.setUpSound(null);return y=B.add.sprite(0,0,"sheet",R[e-1]+"/2"),y.scale.setTo(2,2),y.anchor.setTo(.5,.5),B.physics.arcade.enableBody(y),j.bringToTop(),y.animations.add("fly",Phaser.Animation.generateFrameNames(R[e-1]+"/",1,3,"",1),10,!0),y.body.collideWorldBounds=!0,n=B.add.tween(j).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),n.onComplete.add(function(){var e,n;for(e=0,n=w.length;n>e;e++)t=w[e],t.destroy();return j.destroy()}),y.angle=0,y.revive(),be=B.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR),be.onDown.add(A),v.events.onInputDown.add(A),v.events.onInputDown.add(function(){}),se()},se=function(){be.onDown.removeAll(),v.events.onInputDown.removeAll(),be.onDown.add(A),v.events.onInputDown.add(A),N=!1,D=!1,ce=0,fe.setText("Flappy Bird 2.2 Edition"),q.setText("TOUCH TO FLY\nFLAP bird WINGS"),F.renderable=!1,y.smoothed=!1,y.body.allowGravity=!1,y.reset(.3*B.world.width,B.world.height/2),y.angle=0,y.animations.play("fly"),Ie.removeAll(),K.removeAll()},xe=function(){N=!0,B.time.events.remove(Be),y.body.allowGravity=!0,y.body.gravity.y=n,Be=B.time.events.loop(1/s,ke),fe.setText(ce),q.renderable=!1},De=function(){var e,n,o,a;if(N?D?(n=B.add.tween(y).to({angle:90},100,Phaser.Easing.Bounce.Out,!0),y.body.bottom>=r+3&&(y.y=r-13,y.body.velocity.y=0,y.body.allowGravity=!1,y.body.gravity.y=0)):(y.angle=90*(t+y.body.velocity.y)/t-180,y.angle<-30&&(y.angle=-30),y.angle>80?(y.angle=90,y.animations.stop("fly"),y.frame=R[b]+"/2"):y.animations.play("fly"),B.physics.arcade.overlap(y,Ie,function(){return ve(),C.play()}),!D&&y.body.bottom>=r&&ve(),B.physics.arcade.overlap(y,K,g)):(y.y=B.world.height/2+8*Math.cos(B.time.now/200),y.angle=0),!G)for(o=0,a=w.length;a>o;o++)e=w[o],e.doBounce?e.y=e.trueY+5*Math.cos(B.time.now/200):e.y=e.trueY;D||(v.tilePosition.x-=B.time.physicsElapsed*h/5),D||(L.tilePosition.x-=B.time.physicsElapsed*h)},Q=function(e){var t;return Pe(),ee.revive(),B.world.bringToTop(X),t=B.add.tween(X).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),t.onComplete.add(function(){return re.addEnterCallback(function(){return Ce(),V=!0,oe=re.value,window.localStorage.setItem("name",oe),t=B.add.tween(X).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ae.play(),t.onComplete.add(function(){return ee.kill(),e()})})}),Ae.play()},de=function(){e&&(B.debug.body(y),Ie.forEachAlive(function(e){B.debug.body(e)}),K.forEach(function(e){B.debug.body(e)}))},Se={preload:le,create:k,update:De,render:de},B=new Phaser.Game(u,a,Phaser.CANVAS,ne,Se,!1,!1),pe=ie(32,"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")},WebFontConfig={google:{families:["Press+Start+2P::latin"]},active:main},function(){var e,t;return t=document.createElement("script"),t.src=("https:"===document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",t.type="text/javascript",t.async="true",e=document.getElementsByTagName("script")[0],e.parentNode.insertBefore(t,e)}();
