var WebFontConfig,main;main=function(){var e,t,n,o,r,a,l,i,d,s,h,c,u,f,p,g,v,y,m,w,T,b,k,x,P,C,S,A,E,I,B,D,O,M,N,H,L,_,F,j,G,R,U,W,Y,q,K,V,z,J,Z,Q,X,ee,te,ne,oe,re,ae,le,ie,de,se,he,ce,ue,fe,pe,ge,ve,ye,me,we,Te,be,ke,xe,Pe,Ce,Se,Ae,Ee,Ie,Be,De,Oe,Me;c="flappy",e=!1,h=160,n=1100,t=320,s=1/1200,i=100,d=1,l=6,a=384,u=500,o=64,r=a-o,oe=document.querySelector("#screen"),_=void 0,D=void 0,C=[],P=[],x=[],z=[{name:"Arpit",score:"58",hall:"AZ"},{name:"Apoorv",score:"2",hall:"NH"},{name:"Vikrant",score:"1",hall:"RP"},{name:"Arkanath",score:"100",hall:"MS"}],R=["AZ","MT","RP","SN","NH","PT","RK","LLR","MS","LBS","MMM","HJB"],T=null,V=!1,G=!1,v=null,De=null,K=null,y=null,F=null,j=null,O=null,te=null,J=null,Z=null,ee=null,ge=null,re=null,ue=null,pe=null,q=null,L=null,Be=null,N=null,H=null,ae=null,E=null,fe=null,Y=null,S=null,Ie=null,W=null,b=null,Oe=null,ke=null,ne=12,m=null,Q=null,I=Math.floor,de=function(e,t){var n,o,r;for(o="",n=r=e;1>=e?1>=r:r>=1;n=1>=e?++r:--r)o+=t[Math.floor(Math.random()*t.length)];return o},xe=function(e,t){var n,o,r;return n=null,o=t?"tubeTop":"tubeBottom",r=I(t?e-i/2-320:e+i/2),C.length>0&&"tubeTop"===o?(n=C.pop().revive(),n.reset(B.world.width,r)):P.length>0&&"tubeBottom"===o?(n=P.pop().revive(),n.reset(B.world.width,r)):(n=De.create(B.world.width,r,o),B.physics.arcade.enableBody(n),n.body.allowGravity=!1),n.body.velocity.x=-h,n},Pe=function(){var e,t,n,o;De.forEachAlive(function(e){e.x+e.width<B.world.bounds.left&&("tubeTop"===e.key&&C.push(e.kill()),"tubeBottom"===e.key&&P.push(e.kill()))}),K.forEachAlive(function(e){e.x+e.width<B.world.bounds.left&&x.push(e.kill())}),o=B.world.height/2+(Math.random()-.5)*B.world.height*.2,e=xe(o),n=xe(o,!0),x.length>0?t=x.pop().revive().reset(n.x+n.width/2,0):(t=K.create(n.x+n.width/2,0),B.physics.arcade.enableBody(t),t.width=2,t.height=B.world.height,t.body.allowGravity=!1),t.body.velocity.x=-h},g=function(e,t){K.remove(t),ue+=1,pe.setText(ue),fe.play()},we=function(e){var t,n,o,r,a,l,i;for(o="",n="",r="",J.children[1].setText("Loading.."),J.children[2].setText(""),J.children[0].setText(""),a=l=3,i=J.children.length-1;i>=3?i>=l:l>=i;a=i>=3?++l:--l)J.children[a].kill();return J.children[9].revive(),J.children[10].revive(),t=function(){var e,t,a,l;for(t=a=0,l=z.length-1;l>=0?l>=a:a>=l;t=l>=0?++a:--a)z[t].score<0?(o+="\n-",n+="\n---",r+="\n---",J.children[3+t].kill()):(o+="\n"+(t+1),n+="\n"+z[t].hall,r+="\n"+z[t].score,e=J.children[3+t],e.revive(),e.frameName=z[t].hall+"/2",e.children[0].setText(z[t].hall));return J.children[0].setText(o),J.children[1].setText(n),J.children[2].setText(r),J.children[9].bringToTop()},$.when(e).done(function(e){return $.ajax({type:"GET",url:"/getLeaderboardHall",success:function(e){return z=e,ce(),t()},error:function(){return z=[],ce(),t()}})})},me=function(){return Z.kill(),$.ajax({type:"GET",url:"/getLeader",success:function(e){return 0!==e.length?(Z.revive(),Z.frameName=e[0].hall+"/2",Z.animations.getAnimation("fly")&&Z.animations.getAnimation("fly").destroy(),Z.animations.add("fly",Phaser.Animation.generateFrameNames(e[0].hall+"/",1,3,"",1),10,!0),Z.animations.play("fly"),Z.children[0].setText(e[0].hall)):void 0},error:function(){}})},Te=function(e){var t,n,o,r,a,l,i;for(o="",n="",r="",J.children[1].setText("Loading.."),J.children[2].setText(""),J.children[0].setText(""),a=l=3,i=J.children.length-1;i>=3?i>=l:l>=i;a=i>=3?++l:--l)J.children[a].kill();return J.children[9].revive(),J.children[10].revive(),t=function(){var e,t,a,l;for(t=a=0,l=z.length-1;l>=0?l>=a:a>=l;t=l>=0?++a:--a)z[t].score<0?(o+="\n-",n+="\n---",r+="\n---",J.children[3+t].kill()):(o+="\n"+(t+1),n+="\n"+z[t].name,r+="\n"+z[t].score,e=J.children[3+t],e.revive(),e.frameName=z[t].hall+"/2",e.children[0].setText(z[t].hall));return J.children[0].setText(o),J.children[1].setText(n),J.children[2].setText(r),J.children[9].bringToTop()},$.when(e).done(function(e){return $.ajax({type:"GET",url:"/getLeaderboardSolo",success:function(e){return z=e,ce(),t()},error:function(){return z=[],ce(),t()}})})},ce=function(){for(z.sort(function(e,t){return parseInt(e.score)<parseInt(t.score)});z.length<l;)z.push({name:"---",score:"-1",hall:"DUMMY2"});return z},ve=function(){var e;return e={score:ue,name:re,hall:R[T],key:ge,token:U(ue+ge+c+ue)},$.ajax({type:"POST",data:e,dataType:"text",url:"/sendScore",success:function(e){},error:function(){}})},be=function(){var e,t;return J.frame=0,e=ve(),Q.input.enabled=!1,O.alive?(t=B.add.tween(O).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ie.play(),ke.onDown.removeAll(),v.events.onInputDown.removeAll(),t.onComplete.add(function(){return O.kill(),J.revive(),J.bringToTop(),t=B.add.tween(J).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),we(e),t.onComplete.add(function(){var e;return e=function(){return J.alive?(t=B.add.tween(J).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ie.play(),ke.onDown.removeAll(),v.events.onInputDown.removeAll(),t.onComplete.add(function(){return J.kill(),he()})):he()},v.events.onInputDown.addOnce(e),ke.onDown.addOnce(e)})})):void 0},p=function(e,t,n){var o;return o=B.add.sprite(e,t,"sheet",R[n]+"/2"),o.scale.setTo(2,2),o.smoothed=!1,o.anchor.setTo(.5,.5),o},Se=function(){return v.inputEnabled=!1,ke.onDown.removeAll(),ae.startFocus(),ae.focus=!0,ae.placeHolder.visible=!1},Ee=function(){return ae.endFocus(),ae.focus=!1,v.inputEnabled=!0},M=function(){var e;return ke.onDown.removeAll(),v.events.onInputDown.removeAll(),O.revive(),me(),Q.input.enabled=!1,O.bringToTop(),e=B.add.tween(O).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),e.onComplete.add(function(){var t;return Q.input.enabled=!0,t=function(){return ve(),Q.input.enabled=!1,O.alive?(e=B.add.tween(O).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ie.play(),ke.onDown.removeAll(),v.events.onInputDown.removeAll(),e.onComplete.add(function(){return O.kill(),he()})):he()},v.events.onInputDown.addOnce(t),ke.onDown.addOnce(t)}),Ie.play()},ye=function(){var e;D=!0,y.body.velocity.y>0&&(y.body.velocity.y=100),y.animations.stop(),y.frame=R[T]+"/2",e=window.localStorage.getItem("hiscore"),e=e?e:ue,e=ue>parseInt(e,10)?ue:e,window.localStorage.setItem("hiscore",e),N.setText(ue),H.setText(e),De.forEachAlive(function(e){e.body.velocity.x=0}),K.forEach(function(e){e.body.velocity.x=0}),B.time.events.remove(Oe),B.time.events.add(1e3,function(){return V?M():X(M)}),Y.play()},A=function(){var e;_||Ce(),D||(y.body.gravity.y=0,y.body.velocity.y=-100,e=B.add.tween(y.body.velocity).to({y:-t},25,Phaser.Easing.Bounce.In,!0),e.onComplete.add(function(){return y.body.gravity.y=n}),E.play())},ie=function(){var e;B.load.atlasJSONHash("sheet","assets/sheet.png","assets/sheet.json"),e={spritesheet:{leaderboard:["assets/leaderboard.png",52,29],lbPanel:["assets/lbPanel.png",448,320]},image:{tubeTop:["assets/tube1.png"],tubeBottom:["assets/tube2.png"],ground:["assets/path.png"],bg:["assets/bg2.png"],hall:["assets/hall.png"],gameover:["assets/gameover-panel.png"],nameScreen:["assets/name.png"]},audio:{flap:["assets/sfx_wing.mp3"],score:["assets/sfx_point.mp3"],hurt:["assets/sfx_hit.mp3"],fall:["assets/sfx_die.mp3"],swoosh:["assets/sfx_swooshing.mp3"],click:["assets/keyboard_tap.mp3"],hover:["assets/typewriter_key.mp3"]}},Object.keys(e).forEach(function(t){Object.keys(e[t]).forEach(function(n){B.load[t].apply(B.load,[n].concat(e[t][n]))})})},U=function(e){var t,n,o,r,a,l;if(n=0,0===e.length)return n;for(r=e.length,o=a=0,l=r-1;l>=0?l>=a:a>=l;o=l>=0?++a:--a)t=e.charCodeAt(o),n=(n<<5)-n+t,n|=0;return n},k=function(){var e,t,n,i,s,h,c,f,g,T,k,x,P,C,A,I,D,M,_,j,G,R;for(B.add.plugin(Fabrique.Plugins.InputField),g=window.localStorage.getItem("name"),g&&(V=!0,re=g),B.physics.startSystem(Phaser.Physics.ARCADE),console.log("%chttps://github.com/korroktheslavemaster/flappy-kgp","color: black; font-size: x-large"),x=window.innerWidth/window.innerHeight,document.querySelector("#loading").style.display="none",B.scale.pageAlignVertically=!0,B.smoothed=!1,B.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,B.scale.windowConstraints.bottom="visual",B.scale.setGameSize(u,a),v=B.add.tileSprite(0,0,u,a,"bg"),v.smoothed=!0,v.inputEnabled=!0,v.input.priorityID=0,y=B.add.sprite(0,0),De=B.add.group(),K=B.add.group(),ee=B.add.group(void 0,void 0,!1,!0,Phaser.Physics.ARCADE),F=B.add.tileSprite(0,r,u,o,"ground"),F.tileScale.setTo(d,d),pe=B.add.text(B.world.width/2,B.world.height/4,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),pe.anchor.setTo(.5,.5),q=B.add.text(B.world.width/2,B.world.height-B.world.height/4,"",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),q.anchor.setTo(.5,.5),L=B.add.text(B.world.width/2,B.world.height/2,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),L.anchor.setTo(.5,.5),L.scale.setTo(d,d),J=B.add.sprite(B.world.width/2,1.5*B.world.height,"lbPanel",0),J.anchor.setTo(.5,.5),J.kill(),I=B.add.text(-170,0,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),I.anchor.setTo(.5,.5),A=B.add.text(20,0,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),A.anchor.setTo(.5,.5),D=B.add.text(150,0,"",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"right"}),D.anchor.setTo(.5,.5),G=[I,A,D],M=0,j=G.length;j>M;M++)C=G[M],C.lineSpacing=15;for(J.addChild(I),J.addChild(A),J.addChild(D),c=_=0,R=l-1;R>=0?R>=_:_>=R;c=R>=0?++_:--_)P=p(-120,-105+41*c+10,0),n=B.add.text(0,10,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),n.scale.setTo(.5,.5),n.smoothed=!1,n.anchor.setTo(.5,.5),P.addChild(n),P.kill(),J.addChild(P);e=B.add.button(0-J.width/2,0-J.height/2,void 0,function(){return J.frame=0,we(void 0)},this),e.events.onInputUp.add(function(){return b.play()}),e.width=100,e.height=33,t=B.add.button(104-J.width/2,0-J.height/2,void 0,function(){return J.frame=1,Te(void 0)},this),t.events.onInputUp.add(function(){return b.play()}),t.width=100,t.height=33,e.bringToTop(),t.bringToTop(),J.addChild(e),J.addChild(t),te=B.add.sprite(0,0,"nameScreen",void 0,ee),te.anchor.setTo(.5,.5),te.kill(),ee.x=B.world.width/2,ee.y=1.5*B.world.height,O=B.add.sprite(B.world.width/2,1.5*B.world.height,"gameover"),O.anchor.setTo(.5,.5),O.kill(),Be=B.add.text(0,O.height/2-20,"Touch to Try Again",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),Be.anchor.setTo(.5,.5),O.addChild(Be),h=B.add.text(O.width/4-10,-30,"Score\n\nBest",{font:'24px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),h.anchor.setTo(0,0),O.addChild(h),f=B.add.text(-O.width/3-60,0,"Leader-\nboard -->",{font:'6px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),f.anchor.setTo(0,.5),O.addChild(f),i=B.add.text(-O.width/3-20,60,"Current\nLeader:",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),i.anchor.setTo(0,0),O.addChild(i),N=B.add.text(O.width/4-10,0,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),N.anchor.setTo(0,0),O.addChild(N),H=B.add.text(O.width/4-10,68,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"left"}),H.anchor.setTo(0,0),O.addChild(H),Z=B.add.sprite(100,10,"sheet","NH/2"),Z.scale.setTo(2,2),Z.smoothed=!1,Z.anchor.setTo(.5,.5),i.addChild(Z),s=B.add.text(0,10,"",{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),s.scale.setTo(.5,.5),s.smoothed=!1,s.anchor.setTo(.5,.5),Z.addChild(s),Q=B.add.button(-90,0,"leaderboard",be,this,2,0,1,0),Q.events.onInputUp.add(function(){return b.play()}),Q.events.onInputOver.add(function(){return W.play()}),Q.scale.setTo(2,2),Q.anchor.setTo(.5,.5),Q.smoothed=!1,O.addChild(Q),k=B.add.text(0,-30,"Enter Name",{font:'16px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),k.anchor.setTo(.5,.5),te.addChild(k),T=B.add.text(0,60,"Press Enter to continue",{font:'8px "Press Start 2P"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),T.anchor.setTo(.5,.5),te.addChild(T),ae=B.add.inputField(-75,10,{font:'16px "Press Start 2P"',fill:"#430",cursorColor:"#430",backgroundColor:"#ffffff",placeHolder:"name",placeHolderColor:"#874",height:30,width:150,type:Fabrique.InputType.text},ee),ae.anchor.setTo(0,.3),ae.bringToTop(),E=B.add.audio("flap"),E.allowMultiple=!0,fe=B.add.audio("score"),Y=B.add.audio("hurt"),S=B.add.audio("fall"),Ie=B.add.audio("swoosh"),W=B.add.audio("hover"),b=B.add.audio("click"),y.kill(),m=[],w()},w=function(){var e,t,n,o,r,a,l,i,d,s,h,c;for(Ie.play(),j=B.add.sprite(B.world.width/2,1.5*B.world.height,"hall"),n=B.add.text(0,-100,"Choose Carefully",{font:'30px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),n.renderable=!0,n.anchor.setTo(.5,.5),j.addChild(n),j.anchor.setTo(.5,.5),t=j.width-50,e=j.height-100,a=c=1;ne>=1?ne>=c:c>=ne;a=ne>=1?++c:--c)a-=1,o=parseInt(a/4),r=a%4,l=-j.width/2+72,i=-j.height/2+120,s=Math.round(t/4*r+l),h=Math.round(e/3*o+i),j.addChild(f(s,h,a+1));return d=B.add.tween(j).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0)},f=function(e,t,n){var o,r;return r=B.add.button(e,t,"sheet",function(){return G?void 0:le(n)},this,R[n-1]+"/3",R[n-1]+"/2",R[n-1]+"/1",R[n-1]+"/2"),r.smoothed=!1,r.anchor.setTo(.5,.5),r.animations.add("onHover",[R[n-1]+"/1",R[n-1]+"/2",R[n-1]+"/3",R[n-1]+"/2"],10,!0),r.scale.setTo(2,2),r.smoothed=!1,r.trueY=t,o=B.add.text(0,10,R[n-1],{font:'16px "04b_19regular"',fill:"#fff",stroke:"#430",strokeThickness:4,align:"center"}),o.scale.setTo(.5,.5),o.smoothed=!1,o.anchor.setTo(.5,.5),r.addChild(o),r.setOverSound(b),r.setUpSound(Ie),r.events.onInputOver.add(function(){return r.play("onHover",10,!0,!1),r.doBounce=!0}),r.events.onInputOut.add(function(){return r.animations.stop(),r.doBounce=!1}),r.doBounce=!1,m.push(r),r},le=function(e){var t,n,o,r;for(G=!0,T=e-1,o=0,r=m.length;r>o;o++)t=m[o],t.setOverSound(null),t.setUpSound(null);return y=B.add.sprite(0,0,"sheet",R[e-1]+"/2"),y.scale.setTo(2,2),y.anchor.setTo(.5,.5),B.physics.arcade.enableBody(y),j.bringToTop(),y.animations.add("fly",Phaser.Animation.generateFrameNames(R[e-1]+"/",1,3,"",1),10,!0),y.body.collideWorldBounds=!0,n=B.add.tween(j).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),n.onComplete.add(function(){var e,n;for(e=0,n=m.length;n>e;e++)t=m[e],t.destroy();return j.destroy()}),y.angle=0,y.revive(),ke=B.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR),ke.onDown.add(A),v.events.onInputDown.add(A),v.events.onInputDown.add(function(){}),he()},he=function(){ke.onDown.removeAll(),v.events.onInputDown.removeAll(),ke.onDown.add(A),v.events.onInputDown.add(A),_=!1,D=!1,ue=0,pe.setText("Flappy Bird 2.2 Edition"),q.setText("TOUCH TO FLY\nFLAP bird WINGS"),L.renderable=!1,y.smoothed=!1,y.body.allowGravity=!1,y.reset(.3*B.world.width,B.world.height/2),y.angle=0,y.animations.play("fly"),De.removeAll(),K.removeAll()},Ce=function(){var e;e={key:ge},$.ajax({type:"POST",data:e,dataType:"text",url:"/initGame",success:function(e){},error:function(){}}),_=!0,B.time.events.remove(Oe),y.body.allowGravity=!0,y.body.gravity.y=n,Oe=B.time.events.loop(1/s,Pe),pe.setText(ue),q.renderable=!1},Me=function(){var e,n,o,a;if(_?D?(n=B.add.tween(y).to({angle:90},100,Phaser.Easing.Bounce.Out,!0),y.body.bottom>=r+3&&(y.y=r-13,y.body.velocity.y=0,y.body.allowGravity=!1,y.body.gravity.y=0)):(y.angle=90*(t+y.body.velocity.y)/t-180,y.angle<-30&&(y.angle=-30),y.angle>80?(y.angle=90,y.animations.stop("fly"),y.frame=R[T]+"/2"):y.animations.play("fly"),B.physics.arcade.overlap(y,De,function(){return ye(),S.play()}),!D&&y.body.bottom>=r&&ye(),B.physics.arcade.overlap(y,K,g)):(y.y=B.world.height/2+8*Math.cos(B.time.now/200),y.angle=0),D&&(Z.y=10+5*Math.cos(B.time.now/200)),!G)for(o=0,a=m.length;a>o;o++)e=m[o],e.doBounce?e.y=e.trueY+5*Math.cos(B.time.now/200):e.y=e.trueY;D||(v.tilePosition.x-=B.time.physicsElapsed*h/5),D||(F.tilePosition.x-=B.time.physicsElapsed*h)},X=function(e){var t;return Se(),te.revive(),B.world.bringToTop(ee),t=B.add.tween(ee).to({y:B.world.height/2},800,Phaser.Easing.Back.Out,!0),t.onComplete.add(function(){return ae.addEnterCallback(function(){return Ee(),V=!0,re=ae.value,window.localStorage.setItem("name",re),t=B.add.tween(ee).to({y:1.5*B.world.height},800,Phaser.Easing.Back.In,!0),Ie.play(),t.onComplete.add(function(){return te.kill(),e()})})}),Ie.play()},se=function(){e&&(B.debug.body(y),De.forEachAlive(function(e){B.debug.body(e)}),K.forEach(function(e){B.debug.body(e)}))},Ae={preload:ie,create:k,update:Me,render:se},B=new Phaser.Game(u,a,Phaser.CANVAS,oe,Ae,!1,!1),ge=de(32,"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")},WebFontConfig={google:{families:["Press+Start+2P::latin"]},active:main},function(){var e,t;return t=document.createElement("script"),t.src=("https:"===document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",t.type="text/javascript",t.async="true",e=document.getElementsByTagName("script")[0],e.parentNode.insertBefore(t,e)}();
